...
function salient_child_enqueue_styles() {
  ...
  if ( is_front_page() ) {
    wp_enqueue_style( 'yasa-homepage-style', get_stylesheet_directory_uri() . '/assets/css/home.min.css', '', $nectar_theme_version );
  }
  if ( is_page(1954) ) {
    wp_enqueue_style( 'yasa-homepage-style', get_stylesheet_directory_uri() . '/assets/css/thank-you.min.css', '', $nectar_theme_version );
  }
  if ( is_rtl() ) {
